	...
	pastVotes: [
		{
			...
			electionType:
				String /* Codes: PPP=Presidential Preference Primary Election, PRI=Primary Election, RUN=Runoff Election, GEN=General Election, OTH=Other Election */,
			votingMethod:
				String /* Codes: A=Voted by Mail, B=Vote-by-Mail Ballot Not Counted, E=Voted Early, N=Did Not Vote, P=Provisional Ballot Not Counted, Y=Voted at Polls */,
		},
	],
});
