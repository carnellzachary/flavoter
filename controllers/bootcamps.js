...
exports.getBootcamps = asyncHandler(async (req, res, next) => {  
    // Using middleware (advancedResults) maybe cleaner but a lil slower? Test this  
    let query;
...
exports.deleteBootcamp = asyncHandler(async (req, res, next) => {
    ...
    // .remove() is deprecated, replaced by .deleteOne()
    // Seen some use await before this. Not sure why. Brad doesn't
...
exports.bootcampPhotoUpload = asyncHandler(async (req, res, next) => {
    ...
    // Create custom filename (to prevent overwriting). Could also use a timestamp
